...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1965297568,1765160742}
print("\27[34m"..[[
...
if result.sender_user_id_ == tonumber(1965297568) then
...
if result.id_ == tonumber(1965297568) then
send(msg.chat_id_, msg.id_, "◍ لا يمكنك حظر المطور مطور السورس  \n")
return false 
end
...
if userid == tonumber(1965297568) then
...
local UserName = (b.username_ or "BLACK_TEAM_4")
...
if text == (database:get(bot_id.."VAMBAIR:Name:Bot") or "جوكر") then
Namebot = (database:get(bot_id.."VAMBAIR:Name:Bot") or "جوكر")
local namebot = {
'◍ يوه '..Namebot..' زهق منك😒',
'◍ نعم ياعيون '..Namebot..' 😻💓',
'◍ عايز اي من '..Namebot..' 🙄💛',
...
◍ بضغط ع الزر بلاسفل ..🎮
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◍ CH - [『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 』](t.me/BLACK_TEAM_4) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_, t..'═───═𝐁𝐋𝐀𝐂𝐊═───═\n◍ CH - [『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 』](t.me/BLACK_TEAM_4)  ')
end

-----
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == '"' then
local Text =[[
┍─━─━─┙[𝐁𝐋𝐀𝐂𝐊](t.me/BLACK_TEAM_4)┕─━─━─┑
◍ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ
...
{
{text = '◍ 𝙳𝙴𝚅 ᴊᴏᴋᴇʀ ', url = "https://t.me/UUOUOU_7"}
},
{
{text = '◍ 𝙳𝙴𝚅 ᴊᴀᴄᴋ', url = "https://t.me/V_P_E"}
},
{
{text = '◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂', url = "https://t.me/BLACK_TEAM_4"}
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جاك' or text == 'خالد' or text == 'JACK' or text == '"' then
local Text =[[
◍ جاك صاحبه السورس التواصل
◍ عن طريق معرفه في الاسفل ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝗝𝗔𝗖𝗞🇬', url = "https://t.me/V_P_E"}
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'ادهم' or text == 'مطور السورس' or text == 'مالك السورس' or text == '"' then
local Text =[[
...
{
{text = '𝗗𝗘𝗩 𝗔𝗗𝗛𝗔𝗠', url = "https://t.me/DuuuDD"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DuuuDD&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تابع جديدنا من فضلك ',url="t.me/BLACK_TEAM_4"}}, 
...
彡 .[SOURCE VAMBAIR ◍](t.me/BLACK_TEAM_4)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
local Name_Bot = (database:get(bot_id.."VAMBAIR:Name:Bot") or "جوكر")
